...
const {JSDOM} = jsdom;
const dom = new JSDOM(`<!DOCTYPE html><html lang="en" xmlns="http://www.w3.org/1999/xhtml"><head><meta charset="utf-8" /><title>Crustacean</title></head><body><script src="./50.js"></script></body></html>`);
...
// This is based on code from Emscripten's preamble.js.
            ...
            return {
                imports: {
                    env: {
                        ...
                        __cargo_web_snippet_0f503de1d61309643e0e13a7871406891e3691c9: function (t) {
                            Module.STDWEB_PRIVATE.from_js(t, window)
                        },
                ...
                initialize: function (instance) {
                    ...
                    Module.exports.spyder = function (t, r) {
                        ...
                        console.log(r);
                        try {
                            // var a = Module.STDWEB_PRIVATE.prepare_any_arg(t);
                            // console.log(a);
                            // var b = Module.STDWEB_PRIVATE.prepare_any_arg(r)
                            // console.log(b);
                            // var c = Module.instance.exports.spyder(a, b)
                            // console.log(c);
                            // var d = Module.STDWEB_PRIVATE.acquire_tmp(c);
                            // console.log(d);
                            console.log("↓---加密后s数据---↓")
                            var success = Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.spyder(Module.STDWEB_PRIVATE.prepare_any_arg(t), Module.STDWEB_PRIVATE.prepare_any_arg(r)));
                            console.log(success);
                            return success;
                        } catch (e) {
                            console.log(e);
